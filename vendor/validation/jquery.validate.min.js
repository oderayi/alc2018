...
* Copyright (c) 2013 Jörn Zaefferer; Licensed MIT */(function (t) {
  t.extend(t.fn, {
    ...
    valid() {
      if (t(this[0]).is('form')) return this.validate().form(); let e = !0,
        i = t(this[0].form).validate(); return this.each(function () { e = e && i.element(this); }), e;
    },
    removeAttrs(e) {
      let i = {},
        s = this; return t.each(e.split(/\s/), (t, e) => { i[e] = s.attr(e), s.removeAttr(e); }), i;
    },
    rules(e, i) {
      const s = this[0]; if (e) {
        let r = t.data(s.form, 'validator').settings,
          n = r.rules,
          a = t.validator.staticRules(s); switch (e) { case 'add': t.extend(a, t.validator.normalizeRule(i)), delete a.messages, n[s.name] = a, i.messages && (r.messages[s.name] = t.extend(r.messages[s.name], i.messages)); break; case 'remove': if (!i) return delete n[s.name], a; var u = {}; return t.each(i.split(/\s/), (t, e) => { u[e] = a[e], delete a[e]; }), u; }
      } let o = t.validator.normalizeRules(t.extend({}, t.validator.classRules(s), t.validator.attributeRules(s), t.validator.dataRules(s), t.validator.staticRules(s)), s); if (o.required) { const l = o.required; delete o.required, o = t.extend({ required: l }, o); } return o;
    },
    ...
    prototype: {
      init() {
        function e(e) {
          let i = t.data(this[0].form, 'validator'),
      ...
      elements() {
        let e = this,
          i = {}; return t(this.currentForm).find('input, select, textarea').not(':submit, :reset, :image, [disabled]').not(this.settings.ignore)
      ...
      elementValue(e) {
        let i = t(e).attr('type'),
          s = t(e).val(); return i === 'radio' || i === 'checkbox' ? t(`input[name='${t(e).attr('name')}']:checked`).val() : typeof s === 'string' ? s.replace(/\r/g, '') : s;
      },
      check(e) {
        e = this.validationTargetFor(this.clean(e)); let i,
          s = t(e).rules(),
          r = !1,
          n = this.elementValue(e); for (const a in s) { const u = { method: a, parameters: s[a] }; try { if (i = t.validator.methods[a].call(this, n, e, u.parameters), i === 'dependency-mismatch') { r = !0; continue; } if (r = !1, i === 'pending') return this.toHide = this.toHide.not(this.errorsFor(e)), void 0; if (!i) return this.formatAndAdd(e, u), !1; } catch (o) { throw this.settings.debug && window.console && console.log(`Exception occurred when checking element ${e.id}, check the '${u.method}' method.`, o), o; } } return r ? void 0 : (this.objectLength(s) && this.successList.push(e), !0);
      },
    ...
    classRules(e) {
      let i = {},
        s = t(e).attr('class'); return s && t.each(s.split(' '), function () { this in t.validator.classRuleSettings && t.extend(i, t.validator.classRuleSettings[this]); }), i;
    },
    attributeRules(e) {
      let i = {},
        s = t(e),
        r = s[0].getAttribute('type'); for (const n in t.validator.methods) { var a; n === 'required' ? (a = s.get(0).getAttribute(n), a === '' && (a = !0), a = !!a) : a = s.attr(n), /min|max/.test(n) && (r === null || /number|range|text/.test(r)) && (a = Number(a)), a ? i[n] = a : r === n && r !== 'range' && (i[n] = !0); } return i.maxlength && /-1|2147483647|524288/.test(i.maxlength) && delete i.maxlength, i;
    },
    dataRules(e) {
      let i,
        s,
    ...
    methods: {
      ...
      creditcard(t, e) {
        if (this.optional(e)) return 'dependency-mismatch'; if (/[^0-9 \-]+/.test(t)) return !1; let i = 0,
          s = 0,
          r = !1; t = t.replace(/\D/g, ''); for (let n = t.length - 1; n >= 0; n--) { const a = t.charAt(n); s = parseInt(a, 10), r && (s *= 2) > 9 && (s -= 9), i += s, r = !r; } return i % 10 === 0;
      },
      ...
      remote(e, i, s) {
        if (this.optional(i)) return 'dependency-mismatch'; const r = this.previousValue(i); if (this.settings.messages[i.name] || (this.settings.messages[i.name] = {}), r.originalMessage = this.settings.messages[i.name].remote, this.settings.messages[i.name].remote = r.message, s = typeof s === 'string' && { url: s } || s, r.old === e) return r.valid; r.old = e; const n = this; this.startRequest(i); const a = {}; return a[i.name] = e, t.ajax(t.extend(!0, {
          ...
          data: a,
          success(s) {
            n.settings.messages[i.name].remote = r.originalMessage; const a = s === !0 || s === 'true'; if (a) { const u = n.formSubmitted; n.prepareElement(i), n.formSubmitted = u, n.successList.push(i), delete n.invalid[i.name], n.showErrors(); } else {
              let o = {},
  ...
  const e = {}; if (t.ajaxPrefilter)t.ajaxPrefilter((t, i, s) => { const r = t.port; t.mode === 'abort' && (e[r] && e[r].abort(), e[r] = s); }); else {
    const i = t.ajax; t.ajax = function (s) {
      let r = ('mode' in s ? s : t.ajaxSettings).mode,
        n = ('port' in s ? s : t.ajaxSettings).port; return r === 'abort' ? (e[n] && e[n].abort(), e[n] = i.apply(this, arguments), e[n]) : i.apply(this, arguments);
    };
  }
}(jQuery)), (function (t) { t.extend(t.fn, { validateDelegate(e, i, s) { return this.bind(i, function (i) { const r = t(i.target); return r.is(e) ? s.apply(r, arguments) : void 0; }); } }); }(jQuery));
